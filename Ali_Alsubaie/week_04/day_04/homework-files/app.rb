...
Artist.create(name: "Ali", photo_url: "alkjdfl", nationality: "Saudi")
Artist.create(name: "Abdullah", photo_url: "alkj;lkjadsf", nationality: "Saudi")
ali = Artist.find_by(name: "Ali")

# Change at least 2 of their attributes
ali.update(photo_url: "", nationality: "EASTERN Saudi")
p ali
...
unstoppable.artist.update(name: "ALI")
p unstoppable
...
aSong = Song.create(title: "Blah", album: "blah blah", preview_url: "someURL", artist_id: 10)
...
enya_songs.each { |song| p "I like #{song.title}" }

...
/* 3 */
/*!**************************************************!*\
  !*** ./app/javascript/components/WeatherInfo.js ***!
  \**************************************************/
...
var WeatherInfo = function (_React$Component) {
	...
	function WeatherInfo() {
		...
		return _possibleConstructorReturn(this, (WeatherInfo.__proto__ || Object.getPrototypeOf(WeatherInfo)).call(this));
	}
...
/* 4 */
/*!*************************************************!*\
  !*** ./app/javascript/components/SelectCity.js ***!
  \*************************************************/
/*! exports provided: default */
/*! all exports used */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var SelectCity = function (_React$Component) {
	_inherits(SelectCity, _React$Component);
	...
	function SelectCity() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = SelectCity.__proto__ || Object.getPrototypeOf(SelectCity)).call.apply(_ref, [this].concat(args))), _this), Object.defineProperty(_this, "handleSelection", {
			enumerable: true,
			writable: true,
			value: function value(e) {
				_this.props.getWeatherOf(e.target.value);
			}
	...
	_createClass(SelectCity, [{
		...
		value: function render() {
			return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					"select",
					{ name: "cities", onChange: this.handleSelection },
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						"option",
						{ value: "Riyadh" },
						"Riyadh"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(/*! react */ 0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__WeatherInfo__ = __webpack_require__(/*! ./WeatherInfo */ 3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__SelectCity__ = __webpack_require__(/*! ./SelectCity */ 4);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var App = function (_React$Component) {
	...
	function App() {
		...
		Object.defineProperty(_this, "getWeatherInfo", {
			enumerable: true,
			writable: true,
			value: function value(city) {
				...
				var apiKey = "eba68b5f6c549e09a24ce90322da01fc";
				var params = "?q=" + city + "&appid=" + apiKey;
				var httpOptions = {
					method: "GET",
					dataType: "JSON"
				};
				var url = baseURL + params;
				fetch(url, httpOptions).then(function (r) {
					return r.json();
				}).then(function (data) {
					// console.log(data);
					_this.setState({
	...
	_createClass(App, [{
		...
		value: function render() {
			...
			return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__SelectCity__["default"], { getWeatherOf: this.getWeatherInfo }),
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__WeatherInfo__["default"], { weatherData: this.state.data })
			);
		}
	}]);
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-138533c30dd535a39ad4.js.map
...
var WeatherInfo = function (_React$Component) {
	...
	function WeatherInfo() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = WeatherInfo.__proto__ || Object.getPrototypeOf(WeatherInfo)).call.apply(_ref, [this].concat(args))), _this), Object.defineProperty(_this, "getWeatherInfo", {
			enumerable: true,
			writable: true,
			value: function value() {
				...
				var params = "?q=London&appid=" + apiKey;
				var httpOptions = {
					method: "GET",
					dataType: "JSON"
				};
...
var App = function (_React$Component) {
	...
	function App() {
		...
		Object.defineProperty(_this, "updateWeatehr", {
			enumerable: true,
			writable: true,
	...
	_createClass(App, [{
		...
		value: function render() {
			return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				...
				this.getWeatherInfo(),
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__WeatherInfo__["default"], { updateWeatehr: this.updateWeatehr })
			);
		}
	}]);
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-a10b0b88c4bcec169354.js.map
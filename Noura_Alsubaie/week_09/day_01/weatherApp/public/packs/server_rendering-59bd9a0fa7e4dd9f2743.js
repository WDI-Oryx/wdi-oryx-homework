...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function search(term) {
      ...
      fetch("http://api.openweathermap.org/data/2.5/weather?q=" + term + "&APPID=a115c6a9e3e30e54507360905eca3c1d").then(function (response) {
    ...
    value: function render() {
      ...
      if (this.state.data === null) {
        ...
        var city = this.state.data.name;
        var humidity = this.state.data.main.humidity;
        var country = this.state.data.sys.country;
        // console.log(humidity, city, temp, country)
        result = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__Result__["default"], { temp: temp, city: city, humidity: humidity, country: country });
      }
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        "div",
        null,
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-59bd9a0fa7e4dd9f2743.js.map
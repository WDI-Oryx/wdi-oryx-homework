...
numTwo = 12
if numOne > numTwo
    p "numOne #{numOne} is biggest than numTwo #{numTwo}"
else 
    p "numTwo #{numTwo} is biggest than numOne #{numOne}"
end
...
if user_age >= 18
    ...
    p "Sorry, you can't drive yet #{18-user_age}"
end
...
tests_result = 65
if tests_result >= 90 && tests_result <= 100
    p "A"
elsif tests_result >= 80 && tests_result < 90
    p "B"
elsif tests_result >= 70 && tests_result < 80
    p "C"
elsif tests_result >= 60 && tests_result < 70
    p "D"
else
    p "F"
end

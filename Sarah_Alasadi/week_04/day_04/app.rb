...
new= Song.create(title: "Million Years Ago", album: "EMIR", url: "https://www.youtube.com/watch?v=9LMDg6awPq8" artist_id: 2)
# Delete that song
n.destroy
...
a= artists.find_by(since: 2000)
# Find all artists between 1970 and 1995
a= artists.between(since:1970 < 1995)

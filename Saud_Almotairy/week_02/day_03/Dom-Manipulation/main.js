...
console.log(books);
var booksParagraphs=[];
var booksDescriptions=[];

for (i=0; i<books.length; i++){
    booksParagraphs[i] = document.createElement("p");


booksDescriptions[i] = books[i].title + ",  by " + books [i].author;

booksParagraphs[i].innerText = booksDescriptions[i];
var booksDiv = document.querySelector("div.favoriteBooks");
booksDiv.appendChild(booksParagraphs[i]);
}

...
// A function to determin which line the user picked
function whichLine(lineName) {
    if (lineName === "N") { return N; }
    else if (lineName === "L") { return L; }
    else if (lineName === "six") { return six; }
}
// A function to loop through an array from and to specific points of the array
function fromTo(line, start, end) {
    // TODO: loop through the line array from start to end
    debugger;
    var j = 0;
    var result = [];
...
// The main function to plan the trip
// function planTrip(sLine, sStop, eLine, eStop) {
//     startLine = whichLine(sLine)
//     fromTo(startLine, sStope, communStop)
//     endLine = whichLine(eLine)
//     fromTo(endLine, communStop, eStope)
// }
